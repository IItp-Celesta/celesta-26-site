  ...
  return (
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        borderRadius: '24px',
        padding: '3rem',
        boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 0 40px rgba(14, 165, 233, 0.08)' 
      }}>
        ...
        <header style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <p style={{ color: '#94a3b8', margin: 0, fontSize: '1.15rem', letterSpacing: '0.5px' }}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: isValid ? 'linear-gradient(135deg, #0ea5e9, #2563eb)' : '#1e293b',
                  color: isValid ? '#ffffff' : '#64748b',
                  boxShadow: isValid ? '0 10px 25px -5px rgba(14, 165, 233, 0.4)' : 'inset 0 2px 4px rgba(0,0,0,0.2)',
